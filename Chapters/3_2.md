...
This shared property is used to distinguish between the individual variants at runtime and during type checking.
...
This pattern is used to ensure that all possible variants of a discriminated union are handled. 
