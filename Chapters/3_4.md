...
Even though the same function body handles both cases, 
TypeScript ensures that the resulting type is narrowed based on the argument type passed to `create`.
